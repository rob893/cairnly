# Quality Review — Cairnly Template

*Cairnly full-stack template — review date 2026-06-17.*

Scope: the .NET 10 Web API (`Cairnly.API`) and its tests, the React SPA (`cairnly-ui`), the Bicep infrastructure (`CI/Azure`), and the GitHub Actions workflows. Dimension: **code & configuration quality** — correctness, duplication, dead code, readability, organisation, best practices, test coverage, and docs-vs-reality.
...
- **Location(s):** Cairnly.API/Data/Repositories/UserRepository.cs:88, Cairnly.API/Data/Repositories/UserRepository.cs:100, Cairnly.API/Data/Repositories/UserRepository.cs:104-113, Cairnly.API/Controllers/V1/AuthController.cs:129, Cairnly.API/Data/DatabaseSeeder.cs:141
...
- **Location(s):** Cairnly.API/Utilities/CursorConverters.cs:16-358, Cairnly.API/Extensions/CursorConverters.cs (0 bytes)
...
- **Location(s):** Cairnly.API/Services/Domain/NoteService.cs:45-67, Cairnly.API/Data/Repositories/NoteRepository.cs:22-30, Cairnly.API/Data/Repositories/Repository.cs:134-159
...
- **Location(s):** Cairnly.API/Controllers/V1/AuthController.cs:264-267, Cairnly.API/Controllers/V1/AuthController.cs:384-387
...
- **Severity / Priority:** Medium / 3.0
- **Impact / Risk / Effort:** 3 / 3 / 2
- **Location(s):** Cairnly.API/Data/DatabaseSeeder.cs:138-160, Cairnly.API/Program.cs:58-74
...
- **Location(s):** Cairnly.API/Models/Requests/Auth/RegisterUserUsingGoolgleRequest.cs:5, Cairnly.API/Models/Requests/Auth/GoogleLoginRequest.cs:5
...
- **Location(s):** Cairnly.API.Tests/** (only 4 test files / 19 tests), Cairnly.API/Controllers/V1/AuthController.cs, Cairnly.API/Services/Auth/JwtTokenService.cs, Cairnly.API/Services/Domain/UserService.cs
...
- **Location(s):** Cairnly.API/Controllers/V1/AuthController.cs (6×), Cairnly.API/Controllers/V1/UsersController.cs (6×)
...
- **Severity / Priority:** Low / 2.0
- **Impact / Risk / Effort:** 1 / 1 / 1
- **Location(s):** Cairnly.API/Services/Auth/GitHubOAuthService.cs:62, Cairnly.API/Services/Auth/IGitHubOAuthService.cs, Cairnly.API/Services/Auth/GoogleOAuthService.cs:68-76
...
- **Location(s):** Cairnly.API/Controllers/V1/AuthController.cs:169-268 (Google), Cairnly.API/Controllers/V1/AuthController.cs:283-388 (GitHub)
...
- **Location(s):** Cairnly.API/Controllers/V1/UsersController.cs:42, Cairnly.API/Controllers/V1/NotesController.cs:46, Cairnly.API/Controllers/V1/AuthController.cs:82, AGENTS.md:33
...
- **Location(s):** `cairnly-ui/playwright.config.ts:20-24`; `README.md:136`
...
- **Severity / Priority:** Medium / 3.0
- **Impact / Risk / Effort:** 3 / 3 / 2
- **Location(s):** `cairnly-ui/src/services/axiosConfig.ts:150-181` and `cairnly-ui/src/services/auth.ts:91-99`
...
- **Severity / Priority:** Medium / 3.0
- **Impact / Risk / Effort:** 3 / 3 / 2
- **Location(s):** `cairnly-ui/src/pages/ForgotPasswordPage.tsx:20-24`, `cairnly-ui/src/pages/ResetPasswordPage.tsx:57-63`
...
- **Severity / Priority:** Medium / 3.0
- **Impact / Risk / Effort:** 3 / 3 / 2
- **Location(s):** `cairnly-ui/src/main.tsx:28-37`, `cairnly-ui/src/App.tsx:12-43`
...
- **Location(s):** `cairnly-ui/src/pages/ForgotPasswordPage.tsx:9,25-30,74`
...
- **Severity / Priority:** Low / 3.0
- **Impact / Risk / Effort:** 1 / 2 / 1
- **Location(s):** `cairnly-ui/package.json:26`
...
- **Location(s):** `cairnly-ui/src/pages/LoginPage.tsx:36-50,107-122`, `cairnly-ui/src/pages/RegisterPage.tsx:58-72,157-172`, `cairnly-ui/src/pages/OAuthCallbackPage.tsx:17-33`
...
- **Severity / Priority:** Medium / 2.5
- **Impact / Risk / Effort:** 2 / 3 / 2
- **Location(s):** `cairnly-ui/src/hooks/api.ts:22-44,97-107,122-141`; `cairnly-ui/src/utils/auth.ts:38-50`; `cairnly-ui/src/utils/oauthUtils.ts:133-138`; `cairnly-ui/src/types/auth.ts:22-25`
...
- **Severity / Priority:** Medium / 2.5
- **Impact / Risk / Effort:** 2 / 3 / 2
- **Location(s):** `cairnly-ui/eslint.config.js:23`; usages: `cairnly-ui/src/services/axiosConfig.ts:46-51,68`, `cairnly-ui/vitest.config.ts:5`, `cairnly-ui/vitest.setup.ts:14`
...
- **Severity / Priority:** High / 2.0
- **Impact / Risk / Effort:** 4 / 4 / 4
- **Location(s):** `cairnly-ui/src/utils/__tests__/utils.test.ts`, `errors.test.ts`; missing coverage for `services/axiosConfig.ts`, `contexts/AuthContext.tsx`, `components/ProtectedRoute.tsx`, `utils/auth.ts` (`decodeJwtToken`), `services/auth.ts`, OAuth callback flow
...
- **Location(s):** `cairnly-ui/src/pages/HomePage.tsx:14-42`, `cairnly-ui/src/hooks/api.ts:122-141`
...
- **Severity / Priority:** Low / 2.0
- **Impact / Risk / Effort:** 2 / 2 / 2
- **Location(s):** `cairnly-ui/src/contexts/AuthContext.tsx:130-137`
...
- **Location(s):** `cairnly-ui/src/types/auth.ts:9-20`; usage `pages/LoginPage.tsx:27`, `pages/RegisterPage.tsx:49`
...
- **Security:** `postgres.bicep:64-71` opens the `AllowAllAzureServices` (0.0.0.0) firewall rule and `keyVault.bicep:32` / `appInsights.bicep:28-29` / `logAnalytics.bicep:27-28` set `publicNetworkAccess: Enabled` — review against the intended network posture. `.env` (`cairnly-ui/.env`) is committed (empty values only). These are security-owned.
