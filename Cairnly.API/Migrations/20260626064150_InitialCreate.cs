        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPasswordChange = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedAccountType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenSalt = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpendingPlans_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    Data = table.Column<UserPreferencesData>(type: "jsonb", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    CreatedById = table.Column<int>(type: "integer", nullable: true),
                    UpdatedById = table.Column<int>(type: "integer", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpendingPlanExpenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpendingPlanExpenses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpendingPlanExpenses_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        principalTable: "SpendingPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "SpendingPlanIncomes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpendingPlanIncomes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpendingPlanIncomes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpendingPlanIncomes_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "SpendingPlanExpenseTag",
                columns: table => new
                {
                    SpendingPlanExpenseId = table.Column<int>(type: "integer", nullable: false),
                    TagId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpendingPlanExpenseTag", x => new { x.SpendingPlanExpenseId, x.TagId });
                    table.ForeignKey(
                        name: "FK_SpendingPlanExpenseTag_SpendingPlanExpenses_SpendingPlanExp~",
                        column: x => x.SpendingPlanExpenseId,
                        principalTable: "SpendingPlanExpenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpendingPlanExpenseTag_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "SpendingPlanIncomeTag",
                columns: table => new
                {
                    SpendingPlanIncomeId = table.Column<int>(type: "integer", nullable: false),
                    TagId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpendingPlanIncomeTag", x => new { x.SpendingPlanIncomeId, x.TagId });
                    table.ForeignKey(
                        name: "FK_SpendingPlanIncomeTag_SpendingPlanIncomes_SpendingPlanIncom~",
                        column: x => x.SpendingPlanIncomeId,
                        principalTable: "SpendingPlanIncomes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpendingPlanIncomeTag_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlanExpenses_CategoryId",
                table: "SpendingPlanExpenses",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlanExpenses_SpendingPlanId",
                table: "SpendingPlanExpenses",
                column: "SpendingPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlanExpenses_UserId_SpendingPlanId",
                table: "SpendingPlanExpenses",
                columns: new[] { "UserId", "SpendingPlanId" });

            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlanExpenseTag_TagId",
                table: "SpendingPlanExpenseTag",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlanIncomes_CategoryId",
                table: "SpendingPlanIncomes",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlanIncomes_SpendingPlanId",
                table: "SpendingPlanIncomes",
                column: "SpendingPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlanIncomes_UserId_SpendingPlanId",
                table: "SpendingPlanIncomes",
                columns: new[] { "UserId", "SpendingPlanId" });

            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlanIncomeTag_TagId",
                table: "SpendingPlanIncomeTag",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_SpendingPlans_UserId",
                table: "SpendingPlans",
                column: "UserId");
