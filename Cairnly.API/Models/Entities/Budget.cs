...
/// <summary>
/// Represents a named planning budget owned by a user. A budget aggregates income and expense line
/// items into a normalized summary.
/// </summary>
public sealed class Budget : IIdentifiable<int>, IOwnedByUser<int>, IAuditableEntity
{
    ...
    /// <summary>Gets or sets the budget name.</summary>
    [MaxLength(255)]
    ...
    public List<BudgetIncome> Incomes { get; set; } = [];
    ...
    /// <summary>Gets or sets when the budget was created (UTC).</summary>
    public DateTimeOffset CreatedAt { get; set; } = DateTimeOffset.UtcNow;

    /// <summary>Gets or sets when the budget was last updated (UTC).</summary>
    public DateTimeOffset UpdatedAt { get; set; } = DateTimeOffset.UtcNow;

    /// <summary>Gets or sets the ID of the user who created the budget.</summary>
    public int? CreatedById { get; set; }

    /// <summary>Gets or sets the ID of the user who last updated the budget.</summary>
