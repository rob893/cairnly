...
public sealed class Transaction : IIdentifiable<int>, IOwnedByUser<int>, IAuditableEntity
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether this transaction is a balance adjustment generated by
    /// reconciling the account to a target balance (rather than a real money movement).
    /// </summary>
