...
namespace Cairnly.API.Services.Email;
...
public sealed class AcsEmailService : IEmailService
{
    ...
    public async Task SendEmailConfirmationToUserAsync(User user, string token, CancellationToken cancellationToken)
    {
        ...
        await this.SendEmailToUserAsync(user, "Cairnly Email Confirmation - Verify Your Account! 📧", plainTextMessage, htmlMessage, cancellationToken);
    }
    ...
    public async Task SendResetPasswordToUserAsync(User user, string token, CancellationToken cancellationToken)
    {
        ...
        await this.SendEmailToUserAsync(user, "Cairnly Password Reset - Let's Get You Back In! 🔑", plainTextMessage, htmlMessage, cancellationToken);
    }
