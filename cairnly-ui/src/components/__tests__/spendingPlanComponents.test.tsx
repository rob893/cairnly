...
import { SpendingPlanSummaryCard } from '../spendingPlans/SpendingPlanSummaryCard';
...
describe('SpendingPlanSummaryCard', () => {
  const summary: SpendingPlanSummary = {
    spendingPlanId: 1,
    currency: 'USD',
  ...
  it('renders income, expenses, and remaining rows with formatted currency', () => {
    render(<SpendingPlanSummaryCard summary={summary} currency="USD" isLoading={false} />);
  ...
  it('shows a spinner while loading', () => {
    const { container } = render(<SpendingPlanSummaryCard currency="USD" isLoading={true} />);
