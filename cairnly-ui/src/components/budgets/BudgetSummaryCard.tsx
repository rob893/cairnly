...
import type { BudgetSummary, CadenceAmounts } from '../../types/budgets';
...
/**
 * Displays a budget's normalized income, expenses, and remaining amounts across
 * daily / weekly / monthly / annual cadence columns.
 */
export function BudgetSummaryCard({ summary, currency, isLoading }: BudgetSummaryCardProps) {
  return (
