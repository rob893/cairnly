...
interface LineItemFormModalProps {
  ...
  item?: SpendingPlanIncome | SpendingPlanExpense;
  /** Persists the form. The payload is a superset accepted by both income and expense create/update. */
  onSubmit(payload: CreateSpendingPlanIncomeRequest & CreateSpendingPlanExpenseRequest): Promise<unknown>;
  isPending: boolean;
  error: Error | null;
}

const DEFAULT_INCOME_CADENCE: SpendingPlanCadence = 'Annual';
const DEFAULT_EXPENSE_CADENCE: SpendingPlanCadence = 'Monthly';

/**
 * Modal form for creating or editing a spendingPlan income or expense line item.
        ...
        <Modal.Container size="md">
          <Modal.Dialog>
            ...
            <Modal.Body className="space-y-4">
              ...
              <SelectField<SpendingPlanCadence>
                label="Cadence"
                value={cadence}
                onChange={setCadence}
